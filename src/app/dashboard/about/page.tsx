export default function AboutPage() {
  return (
    <main className="container m-8 rounded-xl bg-white/20 p-4">
      ...
      <p className="mt-2 font-sans text-lg font-normal">
        ...
        aims to provide the information you need to make your voice heard.
      </p>

      <h2 className="mt-8 font-serif text-2xl font-bold">Meet the Team</h2>
    </main>
  );
}
